function [ z, time ] = selective_extraction( X, position, beacons_position, polling_delay, t, radius, measurement_weighted, P_hat )
...
indexes = position_selector(position, beacons_position, radius, 3, measurement_weighted, P_hat);
